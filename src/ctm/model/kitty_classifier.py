'''
from src.ctm.model.ctm import ZeroShotTM
from src.ctm.util.preprocessing import WhiteSpacePreprocessingStopwords
from src.ctm.util.data_preparation import TopicModelDataPreparation
import numpy as np
import pickle
import warnings
...
class Kitty:
    ...
    def get_raw_class_topic_distribution(self):
        pass
